...
```{r cfi-spaghetti-plot, fig.cap="Spaghetti plot of CFI data over time by treatment group."}
...
```{r cfi-summarize-spline-model-1}
ref_grid(cfi_fit,
...
```{r cfi-summarize-spline-model-2}
...
```{r cfi-mean-plot, fig.cap="Mean CFI per treatment group over time as estimated by spline model. Shaded region depicts 95% confidence intervals."}
ref_grid(cfi_fit, 
